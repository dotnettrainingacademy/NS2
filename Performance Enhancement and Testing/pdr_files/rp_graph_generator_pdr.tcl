...
puts $current_file "set title \"Comparative analysis of Packets delivered percentage in $name_of_protocol Routing Protocol and TCP variants combinations\"
...
puts "The Gnuplot file for $name_of_protocol is generated.\n Goto $directory folder and Type Load \"$name_of_protocol\_pdr.p\" in gnuplot to run \n-------------------"
